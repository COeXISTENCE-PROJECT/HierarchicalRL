...
if __name__ == "__main__":
    ...
    # Cluster-wise travel-time history for one multi-line W&B chart.
    # Each active AV cluster contributes exactly one line.
    cluster_tt_history = {c_id: [] for c_id in active_clusters}
    cluster_tt_steps = []
    ...
    for episode in range(training_eps):
        ...
        # Log one scalar per cluster. W&B can show these live and they are also
        # accumulated below for the final combined multi-line chart.
        ...
        maybe_wandb_log(log_data, step=global_step)
    ...
    for episode in range(test_eps):
        ...
        maybe_wandb_log(test_log_data, step=global_step)
        pbar.update()
