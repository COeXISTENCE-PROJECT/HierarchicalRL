...
FINAL_CLUSTERS_NUM = 13 # Number of desired clusters
max_iters = 100
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# ADJUST THIS PATH IF NEEDED
# df_final.to_csv('clustering_ideas\\provins_clustering\\agents_clustered_similarity_measure_shortest_path.csv', index=False)
df_final.to_csv('clustering_ideas\\provins_clustering\\test_1_0_agents_clustered_similarity_measure_shortest_path.csv', index=False)
